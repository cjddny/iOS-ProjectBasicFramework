...
- (void)setUpProperties
{
    ...
    [preBtn setTitle:@"确定" forState:UIControlStateNormal];
...
- (UIToolbar *)toolbar{
    if (!_toolbar) {
        ...
        [_selectButton addTarget:self action:@selector(previewPhotoesSelected) forControlEvents:UIControlEventTouchUpInside];
