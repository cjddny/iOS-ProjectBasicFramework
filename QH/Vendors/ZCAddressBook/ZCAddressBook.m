...
-(void)getPersonInfoArr{
    ...
    for(int i = 0; i < CFArrayGetCount(results); i++)
    {
        ...
        telphone=[telphone stringByReplacingOccurrencesOfString:@"+86" withString:@""];
        
        [dicInfoLocal setObject:telphone forKey:@"mobile"];
        CFRelease(tmlphone);
        /*
         //获取的联系人单一属性:Email(s)
        ...
        [dicInfoLocal setObject:[NSString stringWithFormat:@"%@%@",last,first] forKey:@"name"];
    ...
    self.PhoneArrBlock(YES,_dataArrayDic);
